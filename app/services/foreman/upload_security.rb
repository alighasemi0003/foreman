...
# Intentionally small: size bounds, JPEG magic checks, and download filename
# sanitization. Not a generic upload framework or AV scanner.
#
# JPEG avatar validation is SOI/EOI + structural signature based — not a full
# image decoder (no image-processing gem).
module Foreman
  module UploadSecurity
    ...
    # Content parsing remains Foreman::Util / CacertValidator (OpenSSL).
