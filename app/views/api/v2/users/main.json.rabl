...
attributes :firstname, :lastname, :mail, :mail_enabled, :admin, :auth_source_id, :disabled, :auth_source_name, :timezone, :locale, :last_login_on, :created_at, :updated_at, :password_change_required
